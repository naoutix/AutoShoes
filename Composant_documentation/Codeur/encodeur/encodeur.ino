...
{
//myMotor->setSpeed(a); // Contrôle de vitesse en PWM
//myMotor->run(FORWARD);
}
...
void counter()
{
  //Serial.println("Fuckkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk");
  byte state=PIND;
  
  state|=B11101111;  // mask pour ne regarder que les changements sur 2 et 4 
